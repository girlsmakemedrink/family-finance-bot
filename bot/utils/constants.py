...
WELCOME_NEW_USER = (
    "👋 Привет, <b>{name}</b>!\n\n"
    "Добро пожаловать в <b>Family Finance Bot</b> — твой личный помощник "
    "в учете семейных финансов! 💰\n\n"
    "🔹 <b>Что я умею:</b>\n"
    "• 📊 Отслеживать расходы и доходы\n"
    "• 🏷️ Категоризировать транзакции\n"
    "• 📈 Показывать статистику и аналитику\n"
    "• 👨‍👩‍👧‍👦 Совместный учет для всей семьи\n"
    "• 📱 Работать в любое время из Telegram\n\n"
)
